...
def upgrade() -> None:
    op.add_column('conversations', sa.Column('perceived_disagreement_score', sa.Float(), nullable=True))
    op.add_column('conversations', sa.Column('perceived_breadth_score', sa.Float(), nullable=True))
