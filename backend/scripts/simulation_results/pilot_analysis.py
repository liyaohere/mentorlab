#!/usr/bin/env python3
"""
Pilot Simulation Statistics — Run 003 (GPT-4o, both test types)
...
# ── Config ──────────────────────────────────────────────────────────────
DATA_FILE = Path(__file__).parent / "runs" / "run003_20260406_gpt4o_both.jsonl"
OUTPUT_FILE = Path(__file__).parent / "pilot_statistics.json"
